...
#
               FC := ifort
### Modified PWA 14/08/2019 for fram (following JA)
#           FFLAGS := -heap-arrays -fp-model precise
           FFLAGS := -mcmodel=large -xHOST
### End modified PWA 14/08/2019
              CPP := /usr/bin/cpp
         CPPFLAGS := -P -traditional-cpp -w          ### Modified PWA 14/08/2019 -w turns off warnings
               CC := gcc
              CXX := g++
           CFLAGS :=
         CXXFLAGS :=
