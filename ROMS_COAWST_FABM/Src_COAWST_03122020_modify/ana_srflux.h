...
#  endif
     ...
     &                  1.085_r8*zenith+0.1_r8)
          END IF
!
!!!PWA NOTE: The correction for ocean albedo in the Rutgers trunk code should NOT
!!!          be applied here, because the COAWST code includes separate
!!!          corrections, activated by cpps ALBEDO and ALBEDO_DIRDIFF, that
!!!          are applied within bulk_flux.F and ccsm_flux.F.
