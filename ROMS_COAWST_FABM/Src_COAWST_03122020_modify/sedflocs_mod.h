...
#ifdef SED_FLOCS_KH06
        real(r8), parameter :: rhoref = 1026.95_r8
#else
...
!!!Inserted PWA 09/12/2020
#ifdef SED_FLOCS_KH06
      real(r8) :: f_nf1
      real(r8), parameter :: f_rhos = 2300.0_r8
      real(r8), parameter :: f_betaKH = -0.044022814763920_r8
#endif
!!!End insert PWA 09/12/2020
      real(r8) :: eps
      eps = epsilon(1.0)
!
...
!!!Modified PWA 09/12/2020
#ifdef SED_FLOCS_KH06
         f_nf1 = MIN(3.0_r8, 3.0_r8*(f_diam(itrc)/f_dp0)**f_betaKH)
         f_rho(itrc)=rhoref+(f_rhos-rhoref)*                            &
     &     (f_dp0/f_diam(itrc))**(3.0_r8-f_nf1)
#else
         f_rho(itrc)=rhoref+(2650.0_r8-rhoref)*                         &
     &     (f_dp0/f_diam(itrc))**(3.0_r8-f_nf)
#endif
!!!End modified PWA 09/12/2020
...
#ifdef SED_FLOCS_KH06
      WRITE(*,*) 'Primary particle density (f_rhos)                            : ',f_rhos
      WRITE(*,*) 'Fractal dimension variability exponent (f_betaKH)            : ',f_betaKH
#endif
